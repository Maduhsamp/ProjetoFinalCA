                ...
                <div class ="logreg-box">
                    <div class="form-box login">
                        <form @submit.prevent="novaSenha">
                            ...
                            <div class="input-box">
                                <input v-if="!showPasswordRegister2" type="password" v-model="password_confirmation"  required>
                                <input v-if="showPasswordRegister2" type="text" v-model="password_confirmation" required>
...
<style scoped>
    ...
    .blob{
        ...
        transform: translate(-200px, -200px) rotate(-170deg);
